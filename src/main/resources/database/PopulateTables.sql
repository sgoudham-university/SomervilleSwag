...
INSERT INTO Products (Name, Description, Price, StockLevel, ImagePath)
VALUES
('Somerville Snow Globe', 'Be the envy of your friends with this snazzy snowscene', 20.0, 5, 'src/main/resources/product.images/derek_snowglobe.png'),
...
('Somerville Specs', 'Yo dawg we heard you like glasses', 27.0, 5, 'src/main/resources/product.images/derek_specs.png');
